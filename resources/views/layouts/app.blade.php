                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('games.index') }}">All</a></li>
                                <li><a href="{{ route('games.create') }}">New</a></li>
                          </ul>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('stations.index') }}">All</a></li>
                                <li><a href="{{ route('stations.create') }}">New</a></li>
                          </ul>
                        </li>
                      </ul>
                    <!-- Left Side Of Navbar -->
